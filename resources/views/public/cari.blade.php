            ...
            <div class="col-lg-8 col-lg-offset-2">
                <form id="search-tron" action="{{ route('cari') }}" method="get">
                    ...
                    <div class="input-group" id="main-search">
                        <input type="text" name="location" id="location-field" placeholder="Ketikkan sebuah lokasi ..." value="{{ $request->location }}"
                ...
                <div class="col-lg-3">
                    <div class="thumbnail">
                        ...
                        <div class="name">
                            <h3>{{ $hasil->nama }}</h3>
                            <p class="price">
                                <b>{{ Currency::pricing($hasil->hargamin, $hasil->hargamax) }}</b>
                            </p>
                        </div>
                        <div class="detail">
                            <div class="top">
